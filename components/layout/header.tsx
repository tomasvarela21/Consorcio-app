...
export function Header({ title, subtitle, userEmail, showMenuButton, onMenuClick }: HeaderProps) {
  ...
  return (
    <header className="flex flex-col gap-4 border-b border-slate-200 bg-white px-4 py-4 sm:flex-row sm:items-center sm:justify-between sm:gap-6 sm:px-8">
